...
- **Project Structure & Context:** Always read the root `README.md` and any sub-project `README.md` files (e.g., in `agent/` or `app/` folders) to understand the project's purpose, architecture, and specific development workflows.
